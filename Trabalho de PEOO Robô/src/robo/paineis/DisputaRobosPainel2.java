...
public class DisputaRobosPainel2 extends JPanel implements KeyListener {
    ...
    public DisputaRobosPainel2(Robo roboA, Robo roboB, Alimento alimento) {
        iniciate();
        this.roboA = roboA;
        this.roboB = roboB;
    ...
    public void paint(Graphics g) {
        ...
        g.drawString(this.msgSisA, 160, 10);
